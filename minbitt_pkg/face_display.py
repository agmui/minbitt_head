...
class AnimationTest(AnimationInterface):
    def __init__(self, display: DisplayInterface, proj_env: str):
        ...
        self.left_eye_xy = Point(10, 10)

        self.mouth = display.load_image(proj_env + sprite_dir + "sprites/mouth_pixelated_w.bmp")
        self.mouth_xy = Point(26, 10)

        self.left_eyebrow_start = Point(20, 20)
        self.left_eyebrow_end = Point(25, 20)
    ...
    def animate_face(self, face_data: BlendshapeData, head_input: HeadInput) -> None:
        ...
        self.display.blit(self.L_eye, self.left_eye_xy)
        ...
        # self.display.draw_line(MINBITT_BLUE, self.left_eyebrow_start+(1,1), self.left_eyebrow_end+(3,1), 1)
        # self.display.draw_line(MINBITT_BLUE, self.left_eyebrow_start+(1,4), self.left_eyebrow_end+(5,-3), 1)
        # self.display.draw_line(MINBITT_BLUE, self.left_eyebrow_start+(0,5), self.left_eyebrow_end+(-3, 5), 1)
        # self.display.draw_line(MINBITT_BLUE, self.left_eyebrow_start+(0,6), self.left_eyebrow_end+(-3, 6), 1)
        # self.display.draw_line(MINBITT_BLUE, self.left_eyebrow_start+(0,7), self.left_eyebrow_end+(-3, 7), 1)
        # self.display.draw_circle(MINBITT_BLUE, self.right_eye_xy, 3, True)#FIXME
...
class MinBittAnimation(AnimationInterface):
    def __init__(self, display: DisplayInterface, proj_env: str):
        ...
        self.left_eye_pos = Point(5, 8)  # TODO: use point
